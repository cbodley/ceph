...
public:
  ...
  struct PoolStatOp {
    ...
    fu2::unique_function<void(
      ...
      boost::container::flat_map<std::string, pool_stat_t>) &&> onfinish;
  ...
  struct PoolOp {
    ...
    int64_t pool = 0;
    std::string name;
    fu2::unique_function<void(boost::system::error_code, const ceph::buffer::list&) &&> onfinish;
    uint64_t ontimeout = 0;
    int pool_op = 0;
