...
#ifndef RGW_ASYNC_BIND_HANDLER_H
#define RGW_ASYNC_BIND_HANDLER_H
...
struct associated_executor<rgw::async::CompletionHandler<T, Args...>, Executor> {
  using type = boost::asio::associated_executor_t<T, Executor>;

  static type get(const rgw::async::CompletionHandler<T, Args...>& handler,
...
#endif // RGW_ASYNC_BIND_HANDLER_H
