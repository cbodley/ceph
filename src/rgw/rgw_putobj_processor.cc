...
boost::system::error_code AtomicObjectProcessor::prepare()
{
...
boost::system::error_code
MultipartObjectProcessor::prepare()
{
...
boost::system::error_code AppendObjectProcessor::prepare()
{
  RGWObjState *astate;
...
boost::system::error_code
AppendObjectProcessor::complete(size_t accounted_size, const string &etag,
				ceph::real_time *mtime,
				ceph::real_time set_mtime,
